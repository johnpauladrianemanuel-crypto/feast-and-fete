...
export const MENU_ITEMS: MenuItem[] = [
{
  ...
  category: 'Beef',
  categorySlug: 'beef',
  description: 'Slow-braised oxtail and tripe in a rich, creamy peanut sauce with eggplant, banana blossom, and string beans. Served with bagoong alamang on the side. Ingredients: oxtail, tripe, peanut butter, eggplant, banana blossom, string beans, bagoong alamang, garlic, onion, and spices.',
  price: 980,
...
},
{
  ...
  category: 'Beef',
  categorySlug: 'beef',
  description: 'Tender beef chunks braised in a tomato-based sauce with liver spread, bell peppers, olives, and potatoes. Rich, hearty, and deeply savory. Ingredients: beef, tomato sauce, liver spread, bell peppers, olives, potatoes, garlic, onion, and spices.',
  price: 850,
  servingSize: 'Good for 8–10 persons',
...
},
{
  ...
  category: 'Beef',
  categorySlug: 'beef',
  description: 'Fork-tender beef larded with fat and braised in a tangy tomato-soy sauce with potatoes and carrots. A Filipino fiesta classic. Ingredients: beef, beef fat, tomato sauce, soy sauce, potatoes, carrots, garlic, onion, and spices.',
  price: 820,
  servingSize: 'Good for 8–10 persons',
...
},
{
  ...
  category: 'Beef',
  categorySlug: 'beef',
  description: 'Thinly sliced beef sirloin marinated in soy sauce and calamansi, pan-fried and topped with caramelized onion rings. Ingredients: beef sirloin, soy sauce, calamansi, onions, garlic, cooking oil, and black pepper.',
  price: 780,
  servingSize: 'Good for 8–10 persons',
...
},
{
  ...
  category: 'Pork',
  categorySlug: 'pork',
  description: 'Deep-fried pork belly with impossibly crispy skin and juicy, flavorful meat inside. Served with homemade liver sauce and spiced vinegar. Ingredients: pork belly, liver sauce, vinegar, garlic, chili, salt, and pepper.',
  price: 920,
...
},
{
  ...
  category: 'Pork',
  categorySlug: 'pork',
  description: 'Classic Filipino adobo elevated with creamy coconut milk — pork belly braised in vinegar, soy sauce, garlic, and bay leaves, finished with gata. Ingredients: pork belly, coconut milk, vinegar, soy sauce, garlic, bay leaves, onion, and black pepper.',
  price: 720,
  servingSize: 'Good for 8–10 persons',
...
},
{
  ...
  category: 'Pork',
  categorySlug: 'pork',
  description: 'Sour tamarind broth with tender pork ribs, radish, eggplant, string beans, and kangkong. A comforting Filipino sour soup for the whole family. Ingredients: pork ribs, tamarind, radish, eggplant, string beans, kangkong, tomatoes, onion, and fish sauce.',
  price: 760,
  servingSize: 'Good for 8–10 persons',
...
},
{
  ...
  category: 'Pork',
  categorySlug: 'pork',
  description: 'Whole pork knuckle boiled until tender then deep-fried to a perfect golden crisp. A showstopping centerpiece for any celebration. Ingredients: pork knuckle, garlic, bay leaves, peppercorns, salt, and cooking oil.',
  price: 1100,
  servingSize: 'Good for 10–12 persons',
...
},
{
  ...
  description: 'Bacolod-style grilled chicken marinated in lemongrass, calamansi, and annatto oil. Smoky, tangy, and utterly addictive. Ingredients: chicken, lemongrass, calamansi, annatto oil, garlic, ginger, vinegar, and spices.',
  price: 680,
  servingSize: 'Good for 8–10 persons',
...
},
{
  ...
  category: 'Chicken',
  categorySlug: 'chicken',
  description: 'Light ginger-based chicken soup with green papaya wedges and malunggay leaves. Nourishing, fragrant, and deeply comforting. Ingredients: chicken, ginger, green papaya, malunggay leaves, garlic, onion, and fish sauce.',
  price: 580,
  servingSize: 'Good for 8–10 persons',
...
},
{
  ...
  category: 'Chicken',
  categorySlug: 'chicken',
  description: 'Marinated chicken thigh skewers grilled over charcoal with a sweet-savory Filipino BBQ glaze. A crowd favorite at every party. Ingredients: chicken thighs, soy sauce, banana ketchup, brown sugar, garlic, calamansi, and bamboo skewers.',
  price: 650,
...
},
{
  ...
  description: 'Fresh Spanish mackerel steaks marinated in calamansi, soy sauce, and garlic, then grilled to perfection. Served with sawsawan. Ingredients: Spanish mackerel, calamansi, soy sauce, garlic, cooking oil, and sawsawan.',
  price: 880,
  servingSize: 'Good for 8–10 persons',
...
},
{
  ...
  category: 'Seafood',
  categorySlug: 'seafood',
  description: 'Jumbo prawns sautéed in a fragrant garlic butter sauce with a hint of calamansi and chili. Rich, buttery, and irresistible. Ingredients: prawns, butter, garlic, calamansi, chili, parsley, and black pepper.',
  price: 1050,
  servingSize: 'Good for 8–10 persons',
...
},
{
  ...
  category: 'Seafood',
  categorySlug: 'seafood',
  description: 'A luxurious version of the classic — mixed seafood (shrimp, squid, scallops, mussels) in a velvety peanut sauce with fresh vegetables. Ingredients: shrimp, squid, scallops, mussels, peanut butter, eggplant, banana blossom, string beans, and bagoong alamang.',
  price: 1150,
  servingSize: 'Good for 10–12 persons',
  image: "https://img.rocket.new/generatedImages/rocket_gen_img_1c9882957-1765172054113.png",
...
},
{
  ...
  categorySlug: 'pasta',
  description: 'Stir-fried egg noodles with pork, chicken, shrimp, cabbage, carrots, and snap peas in a savory soy-oyster sauce. A Filipino birthday staple. Ingredients: egg noodles, pork, chicken, shrimp, cabbage, carrots, snap peas, soy sauce, oyster sauce, garlic, and onion.',
  price: 520,
  servingSize: 'Good for 10–12 persons',
...
},
{
  ...
  category: 'Pasta & Noodles',
  categorySlug: 'pasta',
  description: 'Elbow macaroni in a sweet Filipino-style Bolognese topped with creamy béchamel sauce and baked until golden. Kids and adults love it equally. Ingredients: elbow macaroni, ground beef, tomato sauce, banana ketchup, cheddar cheese, milk, butter, flour, and onions.',
  price: 580,
  servingSize: 'Good for 10–12 persons',
...
},
{
  ...
  description: 'A classic Ilocano vegetable medley of ampalaya, eggplant, okra, sitaw, squash, and tomatoes sautéed in shrimp paste (bagoong). Hearty, flavorful, and nutritious. Ingredients: ampalaya, eggplant, okra, sitaw, squash, tomatoes, bagoong alamang, garlic, and onion.',
  price: 480,
  servingSize: 'Good for 8–10 persons',
...
},
{
  ...
  category: 'Vegetables',
  categorySlug: 'vegetables',
  description: 'A colorful stir-fry of cabbage, carrots, bell peppers, snap peas, cauliflower, and quail eggs in a savory oyster sauce. Light, vibrant, and crowd-pleasing. Ingredients: cabbage, carrots, bell peppers, snap peas, cauliflower, quail eggs, oyster sauce, garlic, and onion.',
  price: 420,
  servingSize: 'Good for 8–10 persons',
...
},
{
  ...
  description: 'Traditional Filipino sticky rice cake made with glutinous rice, brown sugar, and coconut milk, topped with caramelized latik (coconut curds). Ingredients: glutinous rice, coconut milk, brown sugar, coconut cream, and salt.',
  price: 420,
...
},
{
  ...
  category: 'Desserts',
  categorySlug: 'desserts',
  description: 'Silky-smooth steamed custard made with egg yolks, condensed milk, and evaporated milk, crowned with a rich amber caramel. The queen of Filipino desserts. Ingredients: egg yolks, condensed milk, evaporated milk, granulated sugar, and vanilla.',
  price: 480,
...
},
{
  ...
  category: 'Desserts',
  categorySlug: 'desserts',
  description: 'The ultimate Filipino shaved ice dessert — a colorful mix of sweetened beans, jellies, kaong, macapuno, ube halaya, leche flan, and creamy ube ice cream. Ingredients: shaved ice, sweetened beans, jellies, kaong, macapuno, ube halaya, leche flan, ube ice cream, and evaporated milk.',
  price: 550,
  servingSize: 'Good for 8–10 persons',
...
},
{
  ...
  description: 'Complete fiesta package: 1 Lechon Kawali tray + 1 Chicken Inasal tray + 1 Pancit Canton tray + 1 Leche Flan. Perfect for 25–30 guests. Ingredients: pork belly, chicken, egg noodles, shrimp, vegetables, soy sauce, calamansi, annatto oil, eggs, condensed milk, and evaporated milk.',
  price: 2450,
...
},
{
  ...
  category: 'Packages',
  categorySlug: 'packages',
  description: 'Premium handaan package: 1 Kare-Kare tray + 1 Pork Sinigang tray + 1 Chicken Afritada tray + 1 Biko. Ideal for intimate family gatherings of 20–25. Ingredients: oxtail, tripe, peanuts, pork ribs, tamarind, chicken, tomato sauce, vegetables, glutinous rice, coconut milk, and brown sugar.',
  price: 2180,
...
},
{
  ...
  category: 'Drinks',
  categorySlug: 'drinks',
  description: 'Refreshing chilled drink made with young coconut strips, pandan-flavored jelly, and creamy coconut milk. A classic Filipino party cooler served in a large dispenser. Ingredients: young coconut, pandan jelly, coconut milk, sugar, and ice.',
  price: 380,
...
},
{
  ...
  category: 'Drinks',
  categorySlug: 'drinks',
  description: 'Classic Filipino street drink with chewy sago pearls, cubed gulaman (agar jelly), and sweet brown sugar syrup. Served cold in a large pitcher. Ingredients: sago pearls, gulaman, brown sugar, water, and ice.',
  price: 280,
  servingSize: 'Good for 15–20 glasses',
...
},
{
  ...
  category: 'Drinks',
  categorySlug: 'drinks',
  description: 'Freshly squeezed calamansi juice sweetened with pure cane sugar and served chilled. Bright, citrusy, and perfectly refreshing for any celebration. Ingredients: calamansi juice, cane sugar, water, and ice.',
  price: 250,
  servingSize: 'Good for 15–20 glasses',
...
},
{
  ...
  category: 'Drinks',
  categorySlug: 'drinks',
  description: 'Traditional Filipino ginger tea brewed strong and served over ice with a touch of honey and calamansi. Warming, soothing, and uniquely Filipino. Ingredients: fresh ginger, honey, calamansi, water, and ice.',
  price: 220,
  servingSize: 'Good for 15–20 glasses',
