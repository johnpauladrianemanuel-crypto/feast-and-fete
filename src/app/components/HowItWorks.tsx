  ...
  return (
    <section className="hiw-v2-root py-24 relative overflow-hidden">
      ...
      <div className="hiw-v2-watermark absolute inset-0 flex items-center justify-center pointer-events-none select-none">
        <span className="font-display font-black text-[20vw] leading-none opacity-[0.025] text-gray-900 whitespace-nowrap">
          HOW IT WORKS
        </span>
      </div>
            ...
            {STEPS?.map((step, i) => (
              ...
              >
                ...
                <div className="relative z-10 space-y-2">
                  <h3 className="font-display text-lg font-black text-gray-900 leading-tight">{step?.title}</h3>
