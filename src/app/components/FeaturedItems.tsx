        ...
        <div className="max-w-screen-2xl mx-auto px-4 lg:px-8 xl:px-10 2xl:px-16 relative z-10">
          <div className="flex items-end justify-between mb-12">
            <div>
              ...
              <h2 className="font-display text-4xl lg:text-5xl font-black text-gray-900 leading-tight">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-4">
            ...
            <div className="lg:col-span-5 feat-v2-hero-card group rounded-3xl overflow-hidden relative">
              ...
              <div className="p-6 space-y-4">
                <div>
                  ...
                  <h3 className="font-display text-2xl font-black text-gray-900 mt-1 leading-tight">{hero.name}</h3>
                  <p className="text-sm text-gray-600 mt-2 line-clamp-2">{hero.description}</p>
                </div>
          ...
          <div className="lg:col-span-7 grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-3 gap-4">
              ...
              >
                ...
                <div className="p-4 flex flex-col flex-1 space-y-3">
                  <div className="flex-1">
                    ...
                    <h3 className="font-display text-sm font-bold text-gray-900 mt-0.5 leading-snug line-clamp-2">{item.name}</h3>
                  </div>
                  <div className="flex items-center justify-between">
            ...
            <div className="feat-v2-cta-card rounded-3xl p-6 flex flex-col items-center justify-center text-center gap-4 cursor-pointer group">
              ...
              <div>
                <p className="font-display text-base font-black text-gray-900">22+ More Trays</p>
                <p className="text-xs text-gray-600 mt-1">Explore the full menu</p>
              </div>
              <Link
                href="/menu-browse-screen"
