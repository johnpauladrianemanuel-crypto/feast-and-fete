...
export default function CartDrawer() {
  ...
  return createPortal(
    <>
      ...
      {/* Drawer */}
      <div
        className="fixed inset-y-0 right-0 w-full max-w-sm min-h-0 max-h-[100dvh] bg-card z-[101] flex flex-col animate-fade-in"
      ...
      >
        ...
        {/* Footer */}
        {hasItems && (
          <div className="sticky bottom-0 border-t border-border px-5 py-4 space-y-3 flex-shrink-0 bg-card">
